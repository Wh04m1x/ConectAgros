...
$(document).ready(function() {
  ...
  var currentDate = 2020 + "/" + 06 + "/" + 14;


  $('#clockImage').countdown(currentDate).on('update.countdown', function(event) {
    var $this = $(this).html(event.strftime(''
      + '<div class="clockCard p-2 mr-1 mb-3 bg-cyan bg-darken-4 box-shadow-2"> <span>%-w</span> <br> <p class="lead mb-0">Semanas </p> </div>'
  ...
  $('#clockFlat').countdown(currentDate).on('update.countdown', function(event) {
    var $this = $(this).html(event.strftime(''
      + '<div class="clockCard p-1"> <span>%-w</span> <br> <p class="bg-amber clockFormat lead p-1 mt-1 black"> Semanas </p> </div>'
